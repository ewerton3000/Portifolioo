<?php
 class Contato
 {
  ...
  //Salvar o contato e retorna boolean
 ...
 public function save()
    {
        ...
        if (!isset($this->id)) {
            $query = "INSERT INTO contatos (".
                implode(', ', array_keys($colunas)).") VALUES (".implode(', ', array_values($colunas)).");";
        } else {
